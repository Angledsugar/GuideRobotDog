...
'''
i = 30
print("Initial_step1_a1,b1")
degree = [90, 180-34.6286, 109] #99.0964 #134.4153, 88.8306
...
packetHandler.write4ByteTxRx(portHandler, RR8_ID, ADDR_XM_GOAL_POSITION, degree_DX[1])
packetHandler.write4ByteTxRx(portHandler, RR9_ID, ADDR_XM_GOAL_POSITION, degree_DX[2])
time.sleep(1)
...
while 1:
    ...
    if portHandler.getBytesAvailable() > 0 : 
        ...
        print("IMU : ", read_data)
    print("A2 :: Step2_FR,RL")
    degree = [90, 180-34.9028, 85.3528]
    degree_DX = [2048, int(degree[1]*(4096//360)), int(degree[2]*(4096//360))]
    packetHandler.write4ByteTxRx(portHandler, FR2_ID, ADDR_XM_GOAL_POSITION, degree_DX[1])
    packetHandler.write4ByteTxRx(portHandler, FR3_ID, ADDR_XM_GOAL_POSITION, degree_DX[2])
    packetHandler.write4ByteTxRx(portHandler, RL11_ID, ADDR_XM_GOAL_POSITION, degree_DX[1])
    packetHandler.write4ByteTxRx(portHandler, RL12_ID, ADDR_XM_GOAL_POSITION, degree_DX[2] + i)
    time.sleep(sec)

    print("A3 :: Step3_FR,RL")
    ...
    print("B4 :: step4_FL,RR")
    degree = [90, 180-30.9475, 98.8754] #134.4153, 88.8306
    degree_DX = [2048, int(degree[1]*(4096//360)), int(degree[2]*(4096//360))]
    packetHandler.write4ByteTxRx(portHandler, FL5_ID, ADDR_XM_GOAL_POSITION, degree_DX[1])
    packetHandler.write4ByteTxRx(portHandler, FL6_ID, ADDR_XM_GOAL_POSITION, degree_DX[2])
    packetHandler.write4ByteTxRx(portHandler, RR8_ID, ADDR_XM_GOAL_POSITION, degree_DX[1])
