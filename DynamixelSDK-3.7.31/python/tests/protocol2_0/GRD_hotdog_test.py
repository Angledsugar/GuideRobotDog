...
packetHandler.write4ByteTxRx(portHandler, FR3_ID, ADDR_XM_ProfileACC, 10)
packetHandler.write4ByteTxRx(portHandler, FL6_ID, ADDR_XM_ProfileACC, 10)
packetHandler.write4ByteTxRx(portHandler, RR9_ID, ADDR_XM_ProfileACC, 10) 
packetHandler.write4ByteTxRx(portHandler, RL12_ID, ADDR_XM_ProfileACC, 10)
...
packetHandler.write4ByteTxRx(portHandler, RR7_ID, ADDR_XM_GOAL_POSITION, 2048)
packetHandler.write4ByteTxRx(portHandler, RR8_ID, ADDR_XM_GOAL_POSITION, 1536)
packetHandler.write4ByteTxRx(portHandler, RR9_ID, ADDR_XM_GOAL_POSITION, 1124)

packetHandler.write4ByteTxRx(portHandler, RL10_ID, ADDR_XM_GOAL_POSITION, 2048)
packetHandler.write4ByteTxRx(portHandler, RL11_ID, ADDR_XM_GOAL_POSITION, 1536)
packetHandler.write4ByteTxRx(portHandler, RL12_ID, ADDR_XM_GOAL_POSITION, 1124)
time.sleep(5)

while 1:
    degree = [90, 145.6987, 57.183]
    ...
    packetHandler.write4ByteTxRx(portHandler, RL11_ID, ADDR_XM_GOAL_POSITION, degree_DX[1])
    packetHandler.write4ByteTxRx(portHandler, RL12_ID, ADDR_XM_GOAL_POSITION, degree_DX[2])
    time.sleep(1)

    degree = [90, 124.1405, 90]
    degree_DX = [2048, int(degree[1]*(4096//360)), int(degree[2]*(4096//360))]
    packetHandler.write4ByteTxRx(portHandler, FR2_ID, ADDR_XM_GOAL_POSITION, degree_DX[1])
    packetHandler.write4ByteTxRx(portHandler, FR3_ID, ADDR_XM_GOAL_POSITION, degree_DX[2])
    packetHandler.write4ByteTxRx(portHandler, RL11_ID, ADDR_XM_GOAL_POSITION, degree_DX[1])
    ...
    """
    position = 300
    for a in range(1, 460):
        position = position + i
        packetHandler.write4ByteTxRx(portHandler, FR3_ID, ADDR_XM_GOAL_POSITION, position)
        packetHandler.write4ByteTxRx(portHandler, FL6_ID, ADDR_XM_GOAL_POSITION, position)
        packetHandler.write4ByteTxRx(portHandler, RR9_ID, ADDR_XM_GOAL_POSITION, position)
        packetHandler.write4ByteTxRx(portHandler, RL12_ID, ADDR_XM_GOAL_POSITION, position)
        print(position)
        time.sleep(0.1)

    print("next")    
    position = 1024
    for a in range(1, 440):
        position = position - i  
        packetHandler.write4ByteTxRx(portHandler, FR3_ID, ADDR_XM_GOAL_POSITION, position)
        packetHandler.write4ByteTxRx(portHandler, FL6_ID, ADDR_XM_GOAL_POSITION, position)
        packetHandler.write4ByteTxRx(portHandler, RR9_ID, ADDR_XM_GOAL_POSITION, position)
    ...
    #Up Hotdog position
    print("Front Hotdog Position")
    packetHandler.write4ByteTxRx(portHandler, FR2_ID, ADDR_XM_GOAL_POSITION, 1536)
    packetHandler.write4ByteTxRx(portHandler, FL5_ID, ADDR_XM_GOAL_POSITION, 1536)
    packetHandler.write4ByteTxRx(portHandler, RR8_ID, ADDR_XM_GOAL_POSITION, 1636)
    packetHandler.write4ByteTxRx(portHandler, RL11_ID, ADDR_XM_GOAL_POSITION, 1636)
    time.sleep(1)
    
    print("Rear Hotdog Position")
    packetHandler.write4ByteTxRx(portHandler, FR2_ID, ADDR_XM_GOAL_POSITION, 1600)
    packetHandler.write4ByteTxRx(portHandler, FL5_ID, ADDR_XM_GOAL_POSITION, 1600)
    packetHandler.write4ByteTxRx(portHandler, RR8_ID, ADDR_XM_GOAL_POSITION, 1600)
    packetHandler.write4ByteTxRx(portHandler, RL11_ID, ADDR_XM_GOAL_POSITION, 1600)
    time.sleep(1)

    
    # Write Dynamixel goal position
    print("Position 1")
    packetHandler.write4ByteTxRx(portHandler, FR1_ID, ADDR_XM_GOAL_POSITION, 2100)
    packetHandler.write4ByteTxRx(portHandler, FR2_ID, ADDR_XM_GOAL_POSITION, 1300)
    time.sleep(0.1)
    packetHandler.write4ByteTxRx(portHandler, FR1_ID, ADDR_XM_GOAL_POSITION, 2048)
    time.sleep(5)
    
    print("Position 2")
    packetHandler.write4ByteTxRx(portHandler, RL10_ID, ADDR_XM_GOAL_POSITION, 2100)
    packetHandler.write4ByteTxRx(portHandler, RL11_ID, ADDR_XM_GOAL_POSITION, 1300)
    time.sleep(0.1)
    packetHandler.write4ByteTxRx(portHandler, RL10_ID, ADDR_XM_GOAL_POSITION, 2048)

    print("Position 3")
    packetHandler.write4ByteTxRx(portHandler, FL4_ID, ADDR_XM_GOAL_POSITION, 2100)
    packetHandler.write4ByteTxRx(portHandler, FL5_ID, ADDR_XM_GOAL_POSITION, 1300)
    time.sleep(0.1)
    packetHandler.write4ByteTxRx(portHandler, FL4_ID, ADDR_XM_GOAL_POSITION, 2048)


    print("Position 2")
    packetHandler.write4ByteTxRx(portHandler, RR7_ID, ADDR_XM_GOAL_POSITION, 2100)
    packetHandler.write4ByteTxRx(portHandler, RR8_ID, ADDR_XM_GOAL_POSITION, 1300)
    time.sleep(0.1)
    packetHandler.write4ByteTxRx(portHandler, RR7_ID, ADDR_XM_GOAL_POSITION, 2048)

    print("Default position")
    packetHandler.write4ByteTxRx(portHandler, FR1_ID, ADDR_XM_GOAL_POSITION, 2048)
    packetHandler.write4ByteTxRx(portHandler, FR2_ID, ADDR_XM_GOAL_POSITION, 1500)
    packetHandler.write4ByteTxRx(portHandler, FR3_ID, ADDR_XM_GOAL_POSITION, 1200)

    packetHandler.write4ByteTxRx(portHandler, FL4_ID, ADDR_XM_GOAL_POSITION, 2048)
    packetHandler.write4ByteTxRx(portHandler, FL5_ID, ADDR_XM_GOAL_POSITION, 1500)
    packetHandler.write4ByteTxRx(portHandler, FL6_ID, ADDR_XM_GOAL_POSITION, 1200)

    packetHandler.write4ByteTxRx(portHandler, RR7_ID, ADDR_XM_GOAL_POSITION, 2048)
    packetHandler.write4ByteTxRx(portHandler, RR8_ID, ADDR_XM_GOAL_POSITION, 1500)
    packetHandler.write4ByteTxRx(portHandler, RR9_ID, ADDR_XM_GOAL_POSITION, 1200)

    packetHandler.write4ByteTxRx(portHandler, RL10_ID, ADDR_XM_GOAL_POSITION, 2048)
    packetHandler.write4ByteTxRx(portHandler, RL11_ID, ADDR_XM_GOAL_POSITION, 1500)
    packetHandler.write4ByteTxRx(portHandler, RL12_ID, ADDR_XM_GOAL_POSITION, 1200)
    time.sleep(1)
    """
