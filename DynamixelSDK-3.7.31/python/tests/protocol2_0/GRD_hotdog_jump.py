...
packetHandler.write4ByteTxRx(portHandler, FR3_ID, ADDR_XM_ProfileACC, 20)
packetHandler.write4ByteTxRx(portHandler, FL6_ID, ADDR_XM_ProfileACC, 20)
packetHandler.write4ByteTxRx(portHandler, RR9_ID, ADDR_XM_ProfileACC, 20) 
packetHandler.write4ByteTxRx(portHandler, RL12_ID, ADDR_XM_ProfileACC, 20)
