...
def leg_current_read(times):
    ...
    for ID in XM_ID:
        ...
        print("Current ", ID , " :" , addr_xm_present_current)
...
while 1:
    ...
    leg_position_write(4,5,6, position[0], position[0], position[0], 0.1)
    leg_position_write(7,8,9, position[0], position[0], position[0], 0.1)
    leg_position_write(10,11,12, position[0], position[0], position[0], 0.1)
    leg_current_read(0)
    time.sleep(1)
    
    #position 2560 
    leg_position_write(1,2,3, position[1], position[1], position[1], 0.1)
    leg_position_write(4,5,6, position[1], position[1], position[1], 0.1)
    leg_position_write(7,8,9, position[1], position[1], position[1], 0.1)
    leg_position_write(10,11,12, position[1], position[1], position[1], 0.1)
    leg_current_read(0)
    time.sleep(1)
