...
BAUDRATE                    = 3000000
DEVICENAME1                  = "COM14" #ID1,2,3,10,11,12
DEVICENAME2                  = "COM3" #ID4,5,6,7,8,9
...
class Hotdog:
    def __init__(self):
        ...
        self.Lp = np.array([[100,-100,170,1],[100,-100,-170,1],[-100,-100,170,1],[-100,-100,-170,1]])
    ...
    def P_write_1(self, ID1, ID2, ID3, Pgain1, Pgain2, Pgain3, times):
    ...
    def P_write_2(self, ID1, ID2, ID3, Pgain1, Pgain2, Pgain3, times):
    ...
    def leg_position_write_1(self, ID1, ID2, ID3, position1, position2, position3, times):
    ...
    def leg_position_write_2(self, ID1, ID2, ID3, position1, position2, position3, times):
    ...
    def leg_position_bulk_write(self, ID1, ID2, ID3, 
                                ID4, ID5, ID6,
                                ID7, ID8, ID9,
                                ID10, ID11, ID12, 
    ...
    def leg_theta(self, angles, center):
        drawRobot(Lp, angles, center)
        #plt.show()
        return Leg_thetaes

    def four_leg_theta(self, angles, center):
        #radian
